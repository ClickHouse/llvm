...
# ROB: LLVM_ENABLE_STRICT_FIXED_SIZE_VECTORS is OFF
...
# option(LLVM_ENABLE_WARNINGS "Enable compiler warnings." OFF) # ROB: was ON
...
# ROB: LLVM_ENABLE_MODULES is OFF
...
#   endif()
#
#   # ROB: warning settings are ignored
...
# ROB: LLVM_USE_SPLIT_DWARF is OFF
...
option(LLVM_ENABLE_EH "Enable Exception handling" ON) # ROB: was ON, but force set to true from outside
option(LLVM_ENABLE_RTTI "Enable run time type information" ON) # ROB: was OFF, but force set to true from outside
...
# ROB: don't instrument the build
...
# ROB: neither use sanitizers nor instrument
...
# endif()
# ROB: LLVM_LINK_LLVM_DYLIB is OFF
